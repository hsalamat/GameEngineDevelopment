...
//Create a new file named MyMaterial1.material in the media\materials\scripts folder of our Ogre3D SDK.
...
OgreTutorial::OgreTutorial()
    : ApplicationContext("week4-7-MaterialDemo")
{
}
...
void OgreTutorial::createScene()
{
    ...
    ManualObject->begin("MyMaterial1", RenderOperation::OT_TRIANGLE_LIST);
