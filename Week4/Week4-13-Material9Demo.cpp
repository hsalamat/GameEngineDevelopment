//Week4-13-Material9Demo.cpp
//The scroll attribute changes the texture coordinates with the given offset.
//Hooman Salamat
...
OgreTutorial::OgreTutorial()
    : ApplicationContext("week4-13-Material8Demo")
{
}
...
void OgreTutorial::createScene()
{
    ...
    ManualObject->begin("MyMaterial9", RenderOperation::OT_TRIANGLE_LIST);
