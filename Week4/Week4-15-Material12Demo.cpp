//Week4-15-Material12Demo.cpp
//Maximize your window!!!
//Now create a second quad and translate it 15 units on the x - axis so that it doesn't
//intersect with the first quad.Also use the setMaterialName() function to change
//the material used by the entity to MyMaterial12 :
//Hooman Salamat
...
OgreTutorial::OgreTutorial()
    : ApplicationContext("week4-15-Material12Demo")
{
}
...
void OgreTutorial::createScene()
{
    ...
    ManualObject->begin("MyMaterial11", RenderOperation::OT_TRIANGLE_LIST);
