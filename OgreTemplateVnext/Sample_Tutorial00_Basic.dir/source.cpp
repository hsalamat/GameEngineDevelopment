...
//
// These samples has many hardcoded paths (e.g. it assumes the current working directory has R/W access)
// which means it will work in Windows and Linux, Mac may work.
// We have set the working directory: $(OGRE_HOME_NEXT)/build/bin/$(Configuration)
// OGRE_HOME_NEXT is an environment variable set to C:\GBC\GAME3121\ogre-next assuming this 
// is the place where you clone the ogre next repository
//---------------------------------------------------------------------------------------
