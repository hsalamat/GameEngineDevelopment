...
void BasicTutorial1::setup()
{
    ...
    //This time OgreNode2 is a child of OgreNode
    Entity* ogreEntity2 = scnMgr->createEntity("ogrehead.mesh");
    SceneNode* ogreNode2 = ogreNode->createChildSceneNode(Vector3(84, 48, 0));
    ogreNode2->attachObject(ogreEntity2);

    //when a parent node moves all its children moves relatively
    ogreNode->setPosition(50, -50, 0);
    
    //You can move an object relative to its current position by using translate 
    //ogreNode->translate(-100, 50, 0);
