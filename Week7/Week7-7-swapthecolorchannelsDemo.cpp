/** @file Week7-7-swapTheColorChannelsDemo
 *  @brief Create a compositor that swaps the green and blue color channels of the scene
 *  @attention: Run with OpenGL 3+
 *
 *   we still use the compositor 3, but this time, go to MyShadersFS31.glsl and swap the colors
...
Game::Game()
    : ApplicationContext("Week7-7-SwapTheColorChannelsDemo")
{
}
