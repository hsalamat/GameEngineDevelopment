/** @file Week6-8-OurFirstShaderDemo.cpp
 *  @brief Using NVIDIA cg
 *
 ...
 * Now we need to write the shader itself. We copied MyShaders.cg  to
...
Game::Game()
    : ApplicationContext("week6-8-ShaderCgDemo3")
{
}
