//Week6-9-ShaderDemo4.cpp
////IMPORTANT: For cg, you will have to use the GL rendering (Do not use GL3+ or DirectX11)
//This is using CG shader!!!
...
OgreTutorial::OgreTutorial()
    : ApplicationContext("week6-9-ShaderDemo4")
{
}
